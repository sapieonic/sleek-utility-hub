  ...
  const handleDecode = () => {
    try {
      ...
      toast({
        ...
        description: "Your URL encoded string has been decoded.",
      });
    } catch (error) {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">URL Decode</h1>
          <p className="text-muted-foreground">Convert URL encoded string to plain text.</p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex justify-end mt-4">
                <Button onClick={handleDecode}>Decode from URL</Button>
              </div>
            </CardContent>
          </Card>
