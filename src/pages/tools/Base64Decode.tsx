  ...
  const handleDecode = () => {
    try {
      ...
      toast({
        ...
        description: "Your Base64 string has been decoded to text.",
      });
    } catch (error) {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">BASE64 Decode</h1>
          <p className="text-muted-foreground">Convert Base64 encoded string to plain text.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Paste your Base64 encoded string to decode
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea 
